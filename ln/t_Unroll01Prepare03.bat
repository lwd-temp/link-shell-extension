...
REM F1
%MKDIR% %TESTROOTSRC%\F1xy > nul
%COPY% test\ln.h %TESTROOTSRC%\F1xy\F1.txt > nul

%MKDIR% %TESTROOTSRC%\F1xy\F1_F0 > nul
%COPY% test\ln.h %TESTROOTSRC%\F1xy\F1_F0\F1_F0.txt > nul

%LN% %OPTION_PREP% %TESTROOTSRC%\F0\F0_F1 %TESTROOTSRC%\F1xy\F1_F0\F1_F0_J0 > nul

REM F2
%MKDIR% %TESTROOTSRC%\F2 > nul
%LN% %OPTION_PREP% %TESTROOTSRC%\F1xy %TESTROOTSRC%\F2\F2_J0 > nul
...
@if [%2] == [symbolic] ( 
  ...
  %LN% %OPTION_PREP% %TESTROOTSRC%\F0\F0_F1\F0_F1.txt %TESTROOTSRC%\F1xy\F1_F0\F1_F0.syl > nul
) 
