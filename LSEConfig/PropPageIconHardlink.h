...
class PropPageIconHardlink : public CPropertyPage
{
	DECLARE_DYNAMIC(PropPageIconHardlink)

public:
	PropPageIconHardlink();
	virtual ~PropPageIconHardlink();
