...
void CTreePropSheetBase::RefillPageTree()
{
  ...
  // TreePropSheetEx: End OnPageTreeSelChanging does not process message.
    ...
    wchar_t TreeItemText[MAX_PATH];
    wcscpy_s(TreeItemText, MAX_PATH, gMlg.Replace(ti.pszText));
    HTREEITEM	hItem = CreatePageTreeItem(TreeItemText);
		ASSERT(hItem);
		if (hItem)
		{
...
//////////////////////////////////////////////////////////////////////
//
DWORD_PTR CTreePropSheetBase::GetNextValidPageIndex(HTREEITEM hTreeItem) const
{
