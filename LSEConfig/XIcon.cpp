...
//=============================================================================
{
	...
	CBitmap bmp;
	BOOL b1 = bmp.CreateCompatibleBitmap(pDC, rectDraw.Width(), rectDraw.Height());
...
//=============================================================================
{
	...
	{
		CRect rectIcon(rect);
		rectIcon.top = rectIcon.top + (rectIcon.Height() - m_nIconSize);


    TRACE("top %d, left %d, bottom %d, right %d\n", rect.top, rect.left, rect.bottom, rect.right);

    int h = rectIcon.Height();
    int b = rectIcon.Width();

		VERIFY(::DrawIconEx(pDC->m_hDC, rectIcon.left, rectIcon.top, m_hIcon, m_nIconSize, m_nIconSize, 0, 0, DI_IMAGE|DI_MASK));
//		VERIFY(::DrawIconEx(pDC->m_hDC, rectIcon.left, rectIcon.top, m_hIcon, m_nIconSize, m_nIconSize, 0, 0, DI_DEFAULTSIZE));
