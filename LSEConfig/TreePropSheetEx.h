...
// Overridables
  ...
  static int CALLBACK MyPropSheetCallback(HWND hWnd, UINT message, LPARAM lParam);
  static LRESULT CALLBACK MyWinProc(HWND hwndDlg, UINT msg, WPARAM wParam, LPARAM lParam) ;

  virtual INT_PTR DoModal();

protected:
  static void RebootExplorer();
...
protected:
	...
	static void OnSysCommand(UINT nID, LPARAM lParam);
